...
module.exports = {
  ...
  rules: {
    ...
    'no-underscore-dangle': [
      error,
      {
        allow: ['__REDUX_DEVTOOLS_EXTENSION_COMPOSE__', '__CONFIG__', '_embedded', '_links'],
      },
    ],
    ...
    'react/sort-comp': [
      ignore,
      {
        order: ['static-methods', 'instance-variables', 'instance-methods', 'lifecycle', 'everything-else', 'render'],
      },
    ],
    ...
    'react/jsx-sort-default-props': [ignore, { ignoreCase: true }],
    ...
    'react/jsx-filename-extension': [warning, { extensions: ['.tsx', '.jsx'] }],
    ...
    'react/function-component-definition': [ignore],
  },
};
